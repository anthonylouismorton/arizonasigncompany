      ...
      <div className='py-16 bg-custom-color'>
        <div className="w-full h-[400px] md:h-[700px] relative">
          <Image
            ...
            alt="Five Below retail store sign by Arizona Sign Company"
            layout="fill"
            objectFit="cover"
            priority={true}
        ...
        <div className="w-full pt-16">
          <div>
            <h2 className="relative text-header-yellow font-bold text-5xl pb-6 pl-6 pr-6 sm:pl-6 md:pl-12 lg:pl-24 before:absolute before:content ' ' before:w-3 before:h-14 before:bg-before-yellow before:left-0 before:top-1/6">
              Who We Serve
            </h2>
          ...
          <div>
            <h2 className="pt-12 relative text-header-yellow font-bold text-5xl pb-6 pl-6 pr-6 sm:pl-6 md:pl-12 lg:pl-24 before:absolute before:content ' ' before:w-3 before:h-14 before:bg-before-yellow before:left-0 before:top-1/6">
