...
const HomeInformation = () => {
  ...
  <div class="flex mt-4 p-4">
    <div class="flex-1 box bg-white p-4 shadow-md">
      <h3 class="text-center font-bold text-xl mb-4">Who We Serve</h3>
      <p>
    ...
    <div class="flex-1 box bg-white p-4 shadow-md mx-4">
      <h3 class="text-center font-bold text-xl mb-4">Our Products and Services</h3>
      <p>
    ...
    <div class="flex-1 box bg-white p-4 shadow-md">
      <h3 class="text-center font-bold text-xl mb-4">Over 70 years of Service</h3>
      <p>
