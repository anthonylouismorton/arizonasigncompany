...
const HomeInformation = () => {
  return (
    <div className="flex flex-col md:flex-row mt-4 p-4 bg-gray-800">
      <div className="flex-1 box bg-white p-4 shadow-md rounded-md mb-4 md:mb-0 md:mr-4">
        <h3 className="text-center font-bold text-xl mb-4">Who We Serve</h3>
        <p>
      ...
      <div className="flex-1 box bg-white p-4 shadow-md rounded-md mb-4 md:mb-0 md:mx-4">
        <h3 className="text-center font-bold text-xl mb-4">Our Products and Services</h3>
        <p>
      ...
      <div className="flex-1 box bg-white p-4 shadow-md rounded-md">
        <h3 className="text-center font-bold text-xl mb-4">Over 70 years of Service</h3>
        <p>
